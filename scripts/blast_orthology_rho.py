...
VI = Path("/home/node/.openclaw/workspace/vi-foundry")
DATA_DIR = VI / "data" / "blast_orthology"
DEP_SCORES = VI / "data" / "t7-ltee" / "gene_dependency_scores.tsv"
IJO_GENES = VI / "data" / "t7-ltee" / "sodalis" / "ecoli_gene_names.txt"
