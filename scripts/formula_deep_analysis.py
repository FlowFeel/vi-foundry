...
ax.set_ylabel('ρ (VI effect size)', fontsize=11)
...
if popt_sig3 is not None:
  ...
  - ρ_max = {popt_sig3[2]:.3f} → k_cult (amplitude of VI effect)
...
if popt_sig3 is not None and sig3_r2 > 0.7:
    print(f"  Sigmoid fit R²={sig3_r2:.3f} — VI effect follows a phase-transition curve")
    ...
    print(f"  Power law fit R²={power_r2:.3f} — VI effect follows a power law")
