---
uri: vi-foundry/inferno-genealogy-pipeline
title: INFERNO Labs Genealogy Pipeline — Design Document
author: VI Foundry Engineering
status: design
version: 1.0.0
updated: 2026-08-18
---
...
> **T15:** Transposition of the VI genealogy chain into a registered, versioned, DOI-trackable pipeline under the INFERNO Labs framework.
...
The VI relaxation formula `dρ/dt = −k₁(ρ − ρ₁) − k₂(ρ − ρ₂)` is the endpoint of a formal chain spanning four stages:
...
- `falsification_ref`: `vi-foundry/inst/results/T2-percolation-results.json`
...
- `falsification_ref`: `vi-foundry/inst/results/T2-rho-sat-results.json`
...
```json
{
  ...
  "description": "Metropolis Monte Carlo simulation of the 2D Ising model on a 16×16 lattice. Part of the VI relaxation formula genealogy chain: Ising → Landau → Cusp → Relaxation. Output: magnetization vs temperature for 20 temperature points. Seed: 42, deterministic.",
  "keywords": [
    "ising model",
    "metropolis monte carlo",
    "statistical physics",
    "vi relaxation formula",
    "genealogy chain",
    "inferno labs"
  ],
  "license": "MIT",
  ...
  "related_identifiers": [
    {
      "relation": "isPartOf",
      "identifier": "https://github.com/phosphene/vi-foundry"
    },
    {
...
```json
{
  ...
  "falsification": {
    ...
    "evidence": "vi-foundry/inst/results/T2-rho-sat-results.json",
...
- In `vi-foundry/keys/pipeline_verify.pub`
...
| Pipeline manifest schema | `vi-foundry/schemas/pipeline-manifest-schema.json` |
